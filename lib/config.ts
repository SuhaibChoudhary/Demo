export const config = {
  ...
  discord: {
    clientId: process.env.NEXT_PUBLIC_DISCORD_CLIENT_ID!, // Re-added NEXT_PUBLIC_
    clientSecret: process.env.DISCORD_CLIENT_SECRET!,
    redirectUri: process.env.NEXT_PUBLIC_DISCORD_REDIRECT_URI!, // Re-added NEXT_PUBLIC_
  },
  jwt: {
